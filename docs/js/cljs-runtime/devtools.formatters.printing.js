...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29137){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29155_SHARP_){
return (!((cljs.core.meta(p1__29155_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29163__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29169){var _e__28311__auto__ = e29169;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e29171){var _e__28311__auto__ = e29171;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29174 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29175 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29175);

try{var map__29176 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29176__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29174);
}});
...
var temp__5733__auto___29201 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29201)){
var managed_print_level_29202 = temp__5733__auto___29201;
var _STAR_print_level_STAR__orig_val__29183_29203 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29184_29204 = managed_print_level_29202;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29184_29204);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29182_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29182_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29183_29203);
}} else {
job_fn();
}
