...
var o28743 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28743["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28744 = temp__5733__auto____$1;
return (o28744["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__28269__auto___29068 = t;
(o__28269__auto___29068["cljs$lang$ctorPrWriter"]).call(o__28269__auto___29068,t,writer);
}catch (e28807){var __29069 = e28807;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28835 = num_code;
switch (G__28835) {
case (1):
return (185);
...
}catch (e28851){var _e__28311__auto__ = e28851;
return false;
}})())){
...
var vec__28856 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28856,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28889){
var vec__28890 = p__28889;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28890,(0),null);
...
var G__29097 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29098 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29097;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28884){
...
var vec__28912 = cljs.core.split_with((function (p1__28911_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28911_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28912,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28912,(1),null);
...
var vec__28918 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28918,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28918,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29106 = cljs.core.rest(remaining_tokens);
var G__29107 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29106;
name_tokens = G__29107;
continue;
} else {
...
var vec__28923 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28923,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28923,(1),null);
var vec__28926 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28926,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28926,(1),null);
var vec__28929 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28929,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28929,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28929,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28929,(3),null);
...
var vec__28937 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28941 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28941,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28941,(1),null);
var vec__28944 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28944,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28944,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28952 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28952) : devtools.munging.parse_fn_info_deep.call(null,G__28952));
})()));
}
} else {
return fn_info;
...
var G__29123 = (arity + (1));
var G__29124 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28967){
var vec__28969 = p__28967;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28969,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28969,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28979_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28979_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28980_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28980_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28989){
var vec__28990 = p__28989;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28990,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28984){
var G__28985 = cljs.core.first(seq28984);
var seq28984__$1 = cljs.core.next(seq28984);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28985,seq28984__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29012__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29012__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29012__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29012__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29013 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29013,(5),null);
...
}catch (e29020){var _e__28311__auto__ = e29020;
...
var G__29152 = (obj[cljs.core.first(path)]);
var G__29153 = cljs.core.rest(path);
obj = G__29152;
path = G__29153;
continue;
} else {
...
var _STAR_ = (function (accum,p__29042){
var vec__29043 = p__29042;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29043,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29043,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29049){
var vec__29050 = p__29049;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29050,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29050,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29050,(2),null);
...
var post_process = (function (p__29059){
var vec__29060 = p__29059;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29060,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29060,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29057_SHARP_){
return (obj[cljs.core.first(p1__29057_SHARP_)]);
}),sorted_matches);
