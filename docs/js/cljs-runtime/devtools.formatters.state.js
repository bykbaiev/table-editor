...
while(true){
if((i__4737__auto___28879 < len__4736__auto___28877)){
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq28845){
...
return cljs.core.some((function (p1__28855_SHARP_){
return (p1__28855_SHARP_ === object);
}),history);
});
