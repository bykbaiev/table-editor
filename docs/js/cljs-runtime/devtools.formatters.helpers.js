...
var G__29127 = devtools.prefs.pref(v);
v = G__29127;
continue;
} else {
return v;
...
}catch (e29080){var _e__28311__auto__ = e29080;
return false;
}})();
...
}catch (e29088){var _e__28311__auto__ = e29088;
return false;
}})();
...
}catch (e29090){var _e__28311__auto__ = e29090;
return false;
}}
}
});
...
var vec__29111 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29111,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29111,(1),null);
...
return cljs.core.some((function (p1__29116_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29116_SHARP_);
}),template);
});
