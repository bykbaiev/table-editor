...
var len__4736__auto___30414 = arguments.length;
var i__4737__auto___30415 = (0);
while(true){
if((i__4737__auto___30415 < len__4736__auto___30414)){
args__4742__auto__.push((arguments[i__4737__auto___30415]));

var G__30416 = (i__4737__auto___30415 + (1));
i__4737__auto___30415 = G__30416;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__30305_30417 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30306_30418 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30307_30419 = true;
var _STAR_print_fn_STAR__temp_val__30308_30420 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30307_30419);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30308_30420);

try{var _STAR_print_level_STAR__orig_val__30309_30421 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30310_30422 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30310_30422);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30309_30421);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30306_30418);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30305_30417);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30295){
...
var new_formatters = current_formatters.filter((function (p1__30357_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30357_SHARP_)));
}));
...
var G__30364_30444 = f;
var target__28304__auto___30445 = G__30364_30444;
if(cljs.core.truth_(target__28304__auto___30445)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30364_30444)].join(''),"\n","target__28304__auto__"].join('')));
}

(target__28304__auto___30445["toString"] = (function (){
...
var G__30369_30447 = "%c%s";
var G__30370_30448 = "color:transparent";
var G__30371_30449 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30369_30447,G__30370_30448,G__30371_30449) : f.call(null,G__30369_30447,G__30370_30448,G__30371_30449));
...
var G__30459 = (i__4737__auto___30457 + (1));
i__4737__auto___30457 = G__30459;
continue;
} else {
}
break;
...
var vec__30385 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30385,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30385,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30460__delegate = function (add_fmt,add_args){
...
var G__30460 = function (add_fmt,var_args){
var add_args = null;
...
while (G__30462__i < G__30462__a.length) {G__30462__a[G__30462__i] = arguments[G__30462__i + 1]; ++G__30462__i;}
  add_args = new cljs.core.IndexedSeq(G__30462__a,0,null);
} 
return G__30460__delegate.call(this,add_fmt,add_args);};
G__30460.cljs$lang$maxFixedArity = 1;
G__30460.cljs$lang$applyTo = (function (arglist__30463){
var add_fmt = cljs.core.first(arglist__30463);
var add_args = cljs.core.rest(arglist__30463);
return G__30460__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30379){
var G__30380 = cljs.core.first(seq30379);
var seq30379__$1 = cljs.core.next(seq30379);
var G__30381 = cljs.core.first(seq30379__$1);
var seq30379__$2 = cljs.core.next(seq30379__$1);
var G__30382 = cljs.core.first(seq30379__$2);
var seq30379__$3 = cljs.core.next(seq30379__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30380,G__30381,G__30382,seq30379__$3);
}));
...
var seq__30390 = cljs.core.seq(features);
var chunk__30391 = null;
var count__30392 = (0);
var i__30393 = (0);
while(true){
if((i__30393 < count__30392)){
var feature = chunk__30391.cljs$core$IIndexed$_nth$arity$2(null,i__30393);
...
var G__30465 = seq__30390;
var G__30466 = chunk__30391;
var G__30467 = count__30392;
var G__30468 = (i__30393 + (1));
seq__30390 = G__30465;
chunk__30391 = G__30466;
count__30392 = G__30467;
i__30393 = G__30468;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__30390);
if(temp__5735__auto__){
var seq__30390__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30390__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__30390__$1);
var G__30473 = cljs.core.chunk_rest(seq__30390__$1);
var G__30474 = c__4556__auto__;
var G__30475 = cljs.core.count(c__4556__auto__);
var G__30476 = (0);
seq__30390 = G__30473;
chunk__30391 = G__30474;
count__30392 = G__30475;
i__30393 = G__30476;
continue;
} else {
var feature = cljs.core.first(seq__30390__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30477 = cljs.core.next(seq__30390__$1);
var G__30478 = null;
var G__30479 = (0);
var G__30480 = (0);
seq__30390 = G__30477;
chunk__30391 = G__30478;
count__30392 = G__30479;
i__30393 = G__30480;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o30405 = temp__5733__auto__;
return (o30405["version"]);
} else {
return null;
}
})() == null);
