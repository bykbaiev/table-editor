...
var i_34042 = (self__.level + (1));
while(true){
if((i_34042 <= (new_level + (1)))){
(update[i_34042] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_34045 = (update[i]).forward;
(x__$2.forward[i] = (links_34045[i]));
...
if(cljs.core.truth_(nx)){
var G__34065 = nx;
var G__34066 = (level__$1 - (1));
x = G__34065;
level__$1 = G__34066;
continue;
} else {
var G__34067 = x;
var G__34068 = (level__$1 - (1));
x = G__34067;
level__$1 = G__34068;
continue;
}
